...
class wifi_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.samp_rate = samp_rate = 31250000/8
        ...
        self._samp_rate_options = [125000000, 62500000, 31250000, 15625000, 7812500, 3906250, 1953125, 976562.5, 488281.25, 244140.625, 122070.3125, 61035.15625]
        # Create the labels list
        self._samp_rate_labels = ['125000000', '62500000', '31250000', '15625000', '7812500', '3906250', '1953125', '976562.5', '488281.25', '244140.625', '122070.3125', '61035.15625']
        ...
        self.top_grid_layout.addWidget(self._gain_win, 6, 1, 1, 1)
        for r in range(6, 7):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        # Create the radio buttons
        self.top_grid_layout.addWidget(self._freq_tool_bar, 4, 1, 1, 1)
        for r in range(4, 5):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._chan_est_group_box, 5, 0, 1, 2)
        for r in range(5, 6):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_0_win, 1, 0, 3, 2)
        for r in range(1, 4):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        # Create the radio buttons
        self.top_grid_layout.addWidget(self._lo_offset_tool_bar, 6, 0, 1, 1)
        for r in range(6, 7):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.ieee802_11_sync_short_0 = ieee802_11.sync_short(0.5, 2, False, False)
        ...
        self.ieee802_11_frame_equalizer_0 = ieee802_11.frame_equalizer(ieee802_11.Equalizer(chan_est), freq, 5e6, False, False)
